...
{   class FullScreenButton extends JButton
    {   private Color hoverBackgroundColor;
        ...
        public FullScreenButton(String text)
        {   super(text);
    ...
    {   JFrame frame = new JFrame("Test button");
        ...
        final FullScreenButton btnSave = new FullScreenButton("Save");
    ...
    {   SwingUtilities.invokeLater(new Runnable()
        {   @Override
            public void run() {
                new FullScreenButtonTest().createAndShowGUI();
            }
        }
        );
    }
